...
- 底层编程 | Low-level Programming
- LLVM 编译器开发 | LLVM Compiler Development
- 二进制漏洞利用 | Binary Exploitation
- 逆向工程 | Reverse Engineering
- 操作系统内核 | OS Kernel
- 漏洞研究 | Vulnerability Research

**当前研究方向 / Current Focus:** 系统架构和安全研究
...
### 编译器与开发工具 | Compiler & Development Tools
![LLVM](https://img.shields.io/badge/-LLVM-262D3D?style=flat-square&logo=llvm&logoColor=white) ![Clang](https://img.shields.io/badge/-Clang-6C8EBF?style=flat-square) ![GCC](https://img.shields.io/badge/-GCC-A42E2B?style=flat-square) ![CMake](https://img.shields.io/badge/-CMake-064F8C?style=flat-square&logo=cmake&logoColor=white)
